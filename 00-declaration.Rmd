...
<span><strong>Lectures are every week:</span></strong>
 <ul>
  <li>**Mondays**: 8-9 am, and </li>
  <li>**Tuesdays**: 8-9 am. </li>
</ul>
</div>
...
<div class="alert alert-danger" role="alert">
The test will be held on **TBD**. **The test will cover all of Module 1 taught material only. The exam will cover both Module 2 & 3 taught material only.**
