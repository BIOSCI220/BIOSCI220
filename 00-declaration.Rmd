...
```{r include=FALSE}
lecs <- matrix(c(1, "R programming and data exploration", "1 - 3", "Assoc. Prof. Beatrix Jones", 
...
<span><strong>Lectures are every week, either:</span></strong>
 <ul>
...
assess <- data.frame(Week =  c(1:6, "Mid-semester break", 7:12 , "Exam Period"), 
                     ...
                     `Inspera Assessment` = c(rep("", 7),"Test", rep("", 5), "Exam"))
...
assess %>%
  ...
  dplyr::mutate(`Inspera Assessment` = kableExtra::cell_spec(`Inspera Assessment`, background = ifelse(Inspera != "", "#CBC3E3", ""))) %>%
