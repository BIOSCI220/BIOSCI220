...
lecs <- matrix(c(1, "R programming and data exploration", "1 - 3", "Dr Charlotte Jones-Todd", 
               ...
               2, "Model-based inference and critical thinking", "7 - 9", "Assoc. Prof. Dave Aguirre", 
               3, "Mathematical modelling in biology", "10 - 12", "Assoc. Prof. Jane Allison"), 
               ncol = 4,byrow = TRUE)
...
<span><strong>Lectures are every week:</span></strong>
 <ul>
  <li>**Tuesdays and Fridays 9-10 am** in 201-393 </li>
</ul>
</div>
...
<div class="alert alert-danger" role="alert">
The test will be held on **Tuesday 29th April 6.30-8.15pm. The test will cover all of Module 1 taught material only. The exam will cover both Module 2 & 3 taught material only.**
...
<ul>
<li>Tuesday 10am-1pm, or</li>
<li>Thursday 2-5pm.</li
</ul>
...
You are scheduled into a lab stream in SSO. While lab attendance is not compulsory, it is highly recommended you attend your scheduled lab stream. There will be an assessed in-class discussion in the week 6 lab, so attendance at that lab stream will be required to gain the grades for that part of the assessment. There is teaching staff to support you through the tasks and answer your course-related questions.
