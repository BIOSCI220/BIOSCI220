...
<div class="alert alert-warning">
  <strong>TASK</strong> Go to the Statistics Department display in the science building foyer (building 303) to see a CD-Rom with the **first** ever version of `R`.
</div>
