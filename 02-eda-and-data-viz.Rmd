...
<div class="alert alert-warning">
  <strong>TODO</strong> Revisit the [Dealing with data] section in the previous chapter and make sure to practice reading the file into `R` using the different ways given. Make sure to restart `R` (i.e., close it down completely and open up a fresh clean workspace) each time.
...
<div class="alert alert-warning">
  <strong>TODO</strong> Run each line of the following code and comment briefly on what each plot shows. 
...
<div class="alert alert-warning">
  <strong>TODO</strong>Try specifying some different colours in  `scale_color_manual()` in the code above. Research Hex colour codes and try using these instead of colour names.
  </div>
...
<div class="alert alert-warning">
  <strong>TODO</strong> What can you say about the distribution of penguin flipper length. Do you this the distributions are symmetrical, skewed, bimodal?
</div>
...
<div class="alert alert-warning">
  <strong>TODO</strong> Before reading the breakdown below write out your own and then compare the two. 
...
<div class="alert alert-warning">
  <strong>TODO</strong> Run each code chunk below. Map each line to a component in the plot produced. Can you improve the plots?
...
<div class="alert alert-warning">
  <strong>TODO</strong> Run the code below. It will give you an error, can you figure out what the cause is?
