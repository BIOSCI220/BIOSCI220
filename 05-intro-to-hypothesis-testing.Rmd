...
ggplot(paua,aes(x = Species, y = Length)) + 
  ...
  geom_text(data = means, 
            aes(x = Species, y = means + 0.5, 
                label = paste0("Species average = ",round(means,3)), color = Species))
```
...
We see something as least as extreme as our observed test statistic 18 times. This translates to a two-sided tail proportion of `r n_exceed/nrow(results)`. The plot below illustrates the location of the observed test statistic in that of the distribution of the test statistics we calculated under the null hypothesis.
