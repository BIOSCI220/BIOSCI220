...
if(!require("equatiomatic", quietly = TRUE, character.only = TRUE)){
  devtools::install_github("datalorax/equatiomatic", auth_token = NULL)
}
if (!require("emo", quietly = TRUE, character.only = TRUE)){
devtools::install_github("hadley/emo", auth_token = NULL)
}
if (!require("icons", quietly = TRUE, character.only = TRUE)){
devtools::install_github("mitchelloharawild/icons", auth_token = NULL)
}
options(warn = 0)
```
